...
<br><hr class="mt-3"> <!-- footer  -->
    <div class="row bg-dark text-light">  
        <div class="col text-center"> 
         <p> &copy; Copyright Alrights Reserved by Riya Khan(ID- 148) </p><p> Department of Computer Science & Engineering,  Northern University of Business & Technology Khulna </p>
        </div>
   </div>
